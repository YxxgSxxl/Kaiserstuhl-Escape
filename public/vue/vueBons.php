...
<section
    ...
    <div class="flex-1">
        <?php if ($_SESSION['lang'] === 'ENG')
            echo '<h1 class="text-white font-semibold mt-0 pt-20 text-4xl md:text-6xl text-center mb-32 select-none">
            CHOOSE
            <span class="text-ks-orange">ONE </span>OF OUR <span class="text-ks-orange">GOOD</span> TO <span
                class="text-ks-orange">OFFER</span>
        </h1>';
        else
            echo '<h1 class="text-white font-semibold mt-0 pt-20 text-4xl md:text-6xl text-center mb-32 select-none">
            CHOISISSEZ
