...
<section class="flex flex-col min-h-screen p-8 bg-no-repeat bg-ks-black">
    ...
    <div
        ...
        <div class="w-[80%] md:w-[40%] mx-auto mb-4 flex h-auto justify-center items-center">
        ...
        <div class="flex flex-col gap-1 w-[auto] md:w-[50%]">
            ...
            <div class="flex flex-col gap-3">
                ...
                <button class="bg-ks-orange rounded-md py-1 md:py-2 hover:bg-ks-white/50">Ajouter au
                    panier</button>
